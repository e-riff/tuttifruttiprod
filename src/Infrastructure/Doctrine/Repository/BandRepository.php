 ...
 */
class BandRepository extends ServiceEntityRepository implements BandRepositoryInterface
{
    ...
    {
        return $this->bandSearch(
            $criteria->query,
            $criteria->events,
            $criteria->musicStyles,
            $criteria->priceCategories
        );
    }
