...
use App\Infrastructure\Symfony\Form\MusicStyleType;
...
class MusicStyleController extends AbstractController
{
    ...
    public function index(MusicStyleRepositoryInterface $musicStyleRepository): Response
    {
    ...
    public function new(Request $request, SluggerInterface $slugger, MusicStyleRepositoryInterface $musicStyleRepository): Response
    {
